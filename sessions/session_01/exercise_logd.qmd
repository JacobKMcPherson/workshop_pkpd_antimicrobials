...
<button id="preset-cefepime-btn" onclick="loadPreset('cefepime')">
Load Cefepime
</button>
<button id="preset-vancomycin-btn" onclick="loadPreset('vancomycin')" style="margin-left: 10px;">
Load Vancomycin  
</button>
<button id="preset-ciprofloxacin-btn" onclick="loadPreset('ciprofloxacin')" style="margin-left: 10px;">
Load Ciprofloxacin
</button>
<button id="preset-gentamicin-btn" onclick="loadPreset('gentamicin')" style="margin-left: 10px;">
Load Gentamicin
</button>
::::
