...
<input type="range" id="fraction-unbound-slider" min="0.01" max="10.0" value="0.1" step="0.01">
<span id="fraction-unbound-value">0.1</span>
:::

::: {.control-group-compact}
<label for="volume-slider">Volume of Distribution (L/kg):</label>
<input type="range" id="volume-slider" min="0.00" max="10.00" value="0.70" step="0.05">
...
<input type="range" id="v2-slider" min="0.2" max="1.5" value="0.5" step="0.1">
...
#### Bacteremia-Specific Pharmacokinetic Concepts
