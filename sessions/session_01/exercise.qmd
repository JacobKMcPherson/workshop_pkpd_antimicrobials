...
<button id="save-patient-btn" onclick="saveCurrentPatient()" style="margin-left: 10px; background-color: #28a745; color: white;">Save Patient</button>
...
<label for="formulation-select" style="font-weight: bold; color: #495057; display: block; margin-bottom: 5px; margin-top: 10px;">Formulation:</label>
...
<label for="pk-model-select" style="font-weight: bold; color: #495057; display: block; margin-bottom: 5px; margin-top: 10px;">PK Model:</label>
...
<label for="kinetics-select" style="font-weight: bold; color: #495057; display: block; margin-bottom: 5px; margin-top: 10px;">Elimination Kinetics:</label>
