...
<legend>1) Primary target of ibezapolstat?</legend> <label><input type="radio" name="q1" value="PolC" required> PolC</label><br> <label><input type="radio" name="q1" value="GyrA"> GyrA</label><br> <label><input type="radio" name="q1" value="RpoB"> RpoB</label> <label><input type="radio" name="q1" value="idk">I don't know</label>
...
[← Pre-Workshop Materials](../../pre-workshop-materials.html){.btn .btn-outline-primary}

</div>

<div>

[Session 1 →](sessions/session_01/page.html){.btn .btn-outline-primary}
