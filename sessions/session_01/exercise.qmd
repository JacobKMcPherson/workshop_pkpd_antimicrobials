...
<input type="range" id="bioavailability-slider" min="0.05" max="1.0" value="0.8" step="0.05">
<span id="bioavailability-value">0.8</span>
:::

::: {.control-group-compact}
<label for="fraction-unbound-slider">Fraction Unbound:</label>
<input type="range" id="fraction-unbound-slider" min="0.05" max="1.0" value="0.5" step="0.05">
...
// NCA calculations for a concentration-time profile
...
// Helper function to calculate concentration based on elimination kinetics
...
// NCA-based concentration calculation (uses one-compartment as basis, then applies NCA calculations)
