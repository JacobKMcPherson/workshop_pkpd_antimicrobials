---
title: "Population Pharmacokinetics (PopPK)"
format: html
---
...
::: control-group-compact
<label for="volume-slider">Volume of Distribution (L/kg):</label> <input type="range" id="volume-slider" min="0.1" max="10" value="0.7" step="0.1"> [0.7]{#volume-value} L/kg
:::
...
::: control-group
<label for="toxicity-slider">Toxicity Threshold (mg/L):</label> <input type="range" id="toxicity-slider" min="0" max="100" value="20" step="1"> [20]{#toxicity-value} mg/L
:::

::: control-group
<label for="efficacy-slider">Efficacy Threshold (mg/L):</label> <input type="range" id="efficacy-slider" min="0" max="100" value="5" step="0.5"> [5]{#efficacy-value} mg/L
:::
:::::
