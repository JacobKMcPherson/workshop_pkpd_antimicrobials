...
function resetSimulation() {
  const elements = ['dose-slider', 'bioavailability-slider', 'interval-slider'];
  const defaults = [250, 0.8, 24];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  ['dose-slider', 'bioavailability-slider', 'interval-slider'].forEach(id => {
