...
<input type="range" id="loading-dose-slider" min="0" max="3000" value="0" step="50">
...
function generateSubjects() {
  ...
  const loadingDose = parseFloat(document.getElementById('loading-dose-slider')?.value || 0);
...
function calculateConcentration(subject, time) {
  ...
  // Calculate contribution from loading dose at time 0 (if loadingDose > 0)
  ...
  // Calculate contribution from each maintenance dose
