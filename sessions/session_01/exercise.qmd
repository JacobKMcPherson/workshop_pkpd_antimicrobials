...
::: {#controls-section .content-section}
## Controls
...
/* Put Controls at left and Plot/Subject Data at right on wide screens */
@media (min-width: 992px) {
  #controls-section { float: left; width: 40%; }
  #plot-section { float: right; width: 60%; }
}

/* Clear floats after the main content (prevents overlap with footer/next blocks) */
main.content::after {
  content: "";
  display: table;
  clear: both;
