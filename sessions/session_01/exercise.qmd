...
function generateRandomPatient() {
  ...
  const creatinine = (Math.random() * (10.0 - 0.5) + 0.5).toFixed(2);
...
function randomizeParameters() {
  ...
  // Handle dose dropdown separately - pick from available discrete options
  const doseOptions = [1, 2, 5, 10, 25, 50, 100, 150, 200, 250, 300, 350, 400, 450, 500, 600, 700, 800, 900, 1000, 1250, 1500, 1750, 2000, 2250, 2500, 3000];
  const randomDose = doseOptions[Math.floor(Math.random() * doseOptions.length)];
  const doseElement = document.getElementById('dose-slider');
  if (doseElement) {
    doseElement.value = randomDose;
  }
