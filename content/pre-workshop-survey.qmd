...
<legend>1) Primary target of ibezapolstat?</legend> 
    <label><input type="radio" name="q1" value="PolC" required> PolC</label><br> 
    <label><input type="radio" name="q1" value="GyrA"> GyrA</label><br> 
    <label><input type="radio" name="q1" value="RpoB"> RpoB</label><br> 
