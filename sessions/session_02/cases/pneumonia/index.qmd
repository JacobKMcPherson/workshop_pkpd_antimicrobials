...
<input type="text" id="drug-name-input" placeholder="Enter drug name (e.g., Cefepime)" style="width: 100%; padding: 8px; border: 1px solid #ced4da; border-radius: 4px; background-color: white;">
</div>
