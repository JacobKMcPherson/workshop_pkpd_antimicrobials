...
function generateSubjects() {
  ...
  // Generate single subject with base parameters (no variability since we have only one subject)
  const clearance = baseParams.clearance;
  const volume = baseParams.volume;
...
function resetSimulation() {
  const elements = ['dose-slider', 'bioavailability-slider'];
  const defaults = [250, 0.8];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  ['dose-slider', 'bioavailability-slider'].forEach(id => {
