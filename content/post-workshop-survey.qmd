...
<fieldset data-qid="q3" data-answer="AUC/MIC">

<legend>3) Which PK/PD parameter is most predictive of clinical success for fluoroquinolones?</legend> <label><input type="radio" name="q3" value="AUC/MIC" required> AUC/MIC ratio</label><br> <label><input type="radio" name="q3" value="Time>MIC"> Time above MIC</label><br> <label><input type="radio" name="q3" value="Cmax/MIC"> Cmax/MIC ratio</label><br> <label><input type="radio" name="q3" value="idk"> I don't know</label>
...
<fieldset data-qid="q4" data-answer="dataframe">

<legend>4) In R, what data structure would you typically use to store pharmacokinetic concentration-time data?</legend> <label><input type="radio" name="q4" value="dataframe" required> Data frame</label><br> <label><input type="radio" name="q4" value="vector"> Vector</label><br> <label><input type="radio" name="q4" value="matrix"> Matrix</label><br> <label><input type="radio" name="q4" value="idk"> I don't know</label>
...
<fieldset data-qid="q5" data-answer="trapezoid">

<legend>5) Which method is commonly used in R for calculating AUC in non-compartmental analysis?</legend> <label><input type="radio" name="q5" value="trapezoid" required> Trapezoidal rule</label><br> <label><input type="radio" name="q5" value="simpson"> Simpson's rule only</label><br> <label><input type="radio" name="q5" value="monte"> Monte Carlo integration</label><br> <label><input type="radio" name="q5" value="idk"> I don't know</label>
...
<fieldset data-qid="q6" data-answer="nlmixr">

<legend>6) Which R package is specifically designed for population pharmacokinetic modeling?</legend> <label><input type="radio" name="q6" value="nlmixr" required> nlmixr</label><br> <label><input type="radio" name="q6" value="ggplot2"> ggplot2</label><br> <label><input type="radio" name="q6" value="dplyr"> dplyr</label><br> <label><input type="radio" name="q6" value="idk"> I don't know</label>
