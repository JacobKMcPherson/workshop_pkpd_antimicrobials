...
<form id="quiz-form">
  <fieldset data-qid="q1" data-answer="PolC">
    ...
    <label><input type="radio" name="q1" value="RpoB"> RpoB</label>
  ...
  <fieldset data-qid="q2" data-answer="Cmax">
    ...
    <label><input type="radio" name="q2" value="t1/2"> t1/2</label>
    <p class="feedback" aria-live="polite"></p>
  </fieldset>
...
document.getElementById("quiz-form").addEventListener("submit", async (e) => {
  ...
  const payload = {
    quiz_id: QUIZ_ID,
    user_id: "", // optionally fill from your site (email, hash, cohort tag)
