...
<input type="number" id="volume-number" min="0.1" max="10" value="0.7" step="0.1" style="width: 80px; margin-left: 10px;">
...
<input type="number" id="dose-number" min="0" max="3000" value="250" step="50" style="width: 80px; margin-left: 10px;">
...
function updateSliderValues() {
  ...
  const numberInputs = [
    { slider: 'dose-slider', number: 'dose-number' },
    { slider: 'volume-slider', number: 'volume-number' }
  ];
